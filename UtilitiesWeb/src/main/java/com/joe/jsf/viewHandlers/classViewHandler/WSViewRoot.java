...
public class WSViewRoot extends UIViewRoot
{
    ...
    public WSViewRoot()
    {
        viewDispatchedTimestamp = null;
    }

    public Long getViewDispatchedTimestamp()
    {
        return viewDispatchedTimestamp;
    }

    public void setViewDispatchedTimestamp(Long long1)
    {
        viewDispatchedTimestamp = long1;
    }

    private Long viewDispatchedTimestamp;
}