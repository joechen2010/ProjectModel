...
public class SendMail {
    ...
    public SendMail( String from, String smtpServer, String username, String password){
    	this.from = from ;
    ...
    public static void main(String[] args) {
        ...
        sendmail.setHost("pop.139.com");
        sendmail.setUserName("chenzhenguang");
        sendmail.setPassWord("system");
        sendmail.setTo("chenzhenguang@139.com");
        sendmail.setFrom("chenzhenguang@139.com");
